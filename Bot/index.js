...
const Categories = ["Diversion", "Utilidad", "Moderacion", "Fortnite"]; //Commands => Category => Command
...
client.login('Nzg2NzIxNzY2Njc1NzEwMDAy.X9KhvQ.8HYRvdonOtpvyqg0_KT3Pqy0YJ0').catch(err => console.log(`Invalid Token Provided!`));